<template>
  <div class="container-fluid home-page">
    ...
    <div class="row">
      <div class="col-md-12">
        <respository-card class="mb-2" v-for="(value,index) in respositoryList" :key="index" :data="value"></respository-card>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    callRestful: function() {
      this.$http.get("https://api.github.com/users/s956142/repos").then(
        response => {
